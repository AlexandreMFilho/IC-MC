...
Nossa ordem de leitura              Ordem da imagem proposta pela professora
  ...
  */
  ...
  float interpol[4]={"0.0,0.0,0.0,0.0"},assintotico = 0.0;
  switch var:
  case 0{
    printf("00000");
    for(i=0;i<4;i++){
    ...
    interpol[0]= interpolador(vertice1,vertice2);
    // interpol[1]= 0.0;
    // interpol[2]= 0.0;
    interpol[3]=;
  }case 10{
  ...
  prinf("%f %f %f %f %f",interpol[0],interpol[1],interpol[2],interpol[3],assintotico);
}
